 ...
 * @generated
 */
public class SourceCodeRootItemProvider extends EntityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SourcecodePackage.Literals.SOURCE_CODE_ROOT__TOPLEVELTYPE);
		}
	...
	public String getText(Object object) {
		String label = ((SourceCodeRoot)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SourceCodeRoot_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SourceCodeRoot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SourcecodePackage.Literals.SOURCE_CODE_ROOT__TOPLEVELTYPE,
				 SourcecodeFactory.eINSTANCE.createTopLevelType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SourcecodePackage.Literals.SOURCE_CODE_ROOT__TOPLEVELTYPE,
				 SourcecodeFactory.eINSTANCE.createClass()));
	}
