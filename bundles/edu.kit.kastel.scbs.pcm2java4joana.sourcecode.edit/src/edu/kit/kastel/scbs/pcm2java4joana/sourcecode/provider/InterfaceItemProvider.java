...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.scbs.pcm2java4joana.sourcecode.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends TopLevelTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_methods_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_methods_feature", "_UI_Interface_type"),
				 SourcecodePackage.Literals.INTERFACE__METHODS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SourcecodePackage.Literals.INTERFACE__METHODS);
		}
