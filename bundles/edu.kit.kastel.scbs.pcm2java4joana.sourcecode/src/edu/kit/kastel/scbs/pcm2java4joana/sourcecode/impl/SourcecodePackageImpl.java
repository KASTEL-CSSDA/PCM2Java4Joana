...
public class SourcecodePackageImpl extends EPackageImpl implements SourcecodePackage {
	 ...
	 * @see edu.kit.kastel.scbs.pcm2java4joana.sourcecode.SourcecodePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static SourcecodePackage init() {
		if (isInited) return (SourcecodePackage)EPackage.Registry.INSTANCE.getEPackage(SourcecodePackage.eNS_URI);
	...
	public void initializePackageContents() {
		...
		initEClass(sourceCodeRootEClass, SourceCodeRoot.class, "SourceCodeRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSourceCodeRoot_Topleveltype(), this.getTopLevelType(), null, "topleveltype", null, 0, -1, SourceCodeRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(classEClass, edu.kit.kastel.scbs.pcm2java4joana.sourcecode.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Implements(), this.getInterface(), null, "implements", null, 0, -1, edu.kit.kastel.scbs.pcm2java4joana.sourcecode.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Fields(), this.getField(), null, "fields", null, 0, -1, edu.kit.kastel.scbs.pcm2java4joana.sourcecode.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBuiltInType_BuiltInType(), this.getBuiltInTypes(), "builtInType", null, 1, 1, BuiltInType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(referenceTypeEClass, ReferenceType.class, "ReferenceType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceType_Topleveltype(), this.getTopLevelType(), null, "topleveltype", null, 1, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
