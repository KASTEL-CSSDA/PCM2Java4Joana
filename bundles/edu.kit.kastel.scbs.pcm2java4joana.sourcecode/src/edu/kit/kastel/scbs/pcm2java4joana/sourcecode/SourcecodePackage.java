...
public interface SourcecodePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SOURCE_CODE_ROOT__ID = IdentifierPackage.ENTITY__ID;
	 ...
	 * @ordered
	 */
	int SOURCE_CODE_ROOT__ENTITY_NAME = IdentifierPackage.ENTITY__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int SOURCE_CODE_ROOT__TOPLEVELTYPE = IdentifierPackage.ENTITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SOURCE_CODE_ROOT_FEATURE_COUNT = IdentifierPackage.ENTITY_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SOURCE_CODE_ROOT_OPERATION_COUNT = IdentifierPackage.ENTITY_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_TYPE__ID = IdentifierPackage.ENTITY__ID;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_TYPE__ENTITY_NAME = IdentifierPackage.ENTITY__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_TYPE_FEATURE_COUNT = IdentifierPackage.ENTITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_TYPE_OPERATION_COUNT = IdentifierPackage.ENTITY_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTERFACE__ID = TOP_LEVEL_TYPE__ID;
	 ...
	 * @ordered
	 */
	int INTERFACE__ENTITY_NAME = TOP_LEVEL_TYPE__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int CLASS__ID = TOP_LEVEL_TYPE__ID;
	 ...
	 * @ordered
	 */
	int CLASS__ENTITY_NAME = TOP_LEVEL_TYPE__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int FIELD_FEATURE_COUNT = IdentifierPackage.ENTITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int METHOD__ENTITY_NAME = FIELD__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int VARIABLE__ENTITY_NAME = FIELD__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int BUILT_IN_TYPE__ID = TYPE__ID;
	 ...
	 * @ordered
	 */
	int BUILT_IN_TYPE__ENTITY_NAME = TYPE__ENTITY_NAME;
	 ...
	 * @ordered
	 */
	int REFERENCE_TYPE__ENTITY_NAME = TYPE__ENTITY_NAME;
