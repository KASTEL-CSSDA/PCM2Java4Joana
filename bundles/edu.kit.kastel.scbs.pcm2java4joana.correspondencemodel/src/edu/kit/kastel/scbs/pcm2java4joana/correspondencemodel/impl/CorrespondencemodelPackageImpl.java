...
public class CorrespondencemodelPackageImpl extends EPackageImpl implements CorrespondencemodelPackage {
	...
	public void createPackageContents() {
		...
		createEReference(component2ClassEClass, COMPONENT2_CLASS__PCM_COMPONENT);
		...
		createEReference(interface2InterfaceEClass, INTERFACE2_INTERFACE__PCM_INTERFACE);
		...
		createEReference(operation2MethodEClass, OPERATION2_METHOD__PCM_OPERATION);
		...
		createEReference(parameter2ParameterEClass, PARAMETER2_PARAMETER__PCM_PARAMETER);
	...
	public void initializePackageContents() {
		...
		initEReference(getInterface2Interface_PcmInterface(), theRepositoryPackage.getOperationInterface(), null, "pcmInterface", null, 1, 1, Interface2Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
