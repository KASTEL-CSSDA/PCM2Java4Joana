...
//	private static final String ACCESS_ANALYSIS_ADVESARY_FILE_ENDING = "adversary";
	...
	public ClientAnalysisModel(Repository repository, ConfidentialitySpecification confidentiality, IPath baseFolder) {
...
//				break;
		...
		return hasRepository && hasConfidentiality;
	}
...
//			resourceAdversary.load(null);
		...
		return new ClientAnalysisModel(repository, confidentiality, basePath);
	}
