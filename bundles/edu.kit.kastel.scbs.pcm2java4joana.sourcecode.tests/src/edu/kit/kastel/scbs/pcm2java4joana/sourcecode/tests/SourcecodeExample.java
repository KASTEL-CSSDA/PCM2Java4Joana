...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sourcecode</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SourcecodeExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sourcecode"));
				SourceCodeRoot root = SourcecodeFactory.eINSTANCE.createSourceCodeRoot();
