...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.scbs.pcm2java4joana.joana.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider extends FlowSpecificationElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAnnotatedParameterNamePropertyDescriptor(object);
		}
	...
	protected void addAnnotatedParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Annotation_annotatedParameter_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Annotation_annotatedParameter_feature",
								"_UI_Annotation_type"),
						JoanaPackage.Literals.ANNOTATION__ANNOTATED_PARAMETER, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Annotated Parameter Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAnnotatedParameterNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Annotation_annotatedParameterName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Annotation_annotatedParameterName_feature",
								"_UI_Annotation_type"),
						JoanaPackage.Literals.ANNOTATION__ANNOTATED_PARAMETER_NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JoanaPackage.Literals.ANNOTATION__SECURITYLEVEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(JoanaPackage.Literals.ANNOTATION__SECURITYLEVEL,
