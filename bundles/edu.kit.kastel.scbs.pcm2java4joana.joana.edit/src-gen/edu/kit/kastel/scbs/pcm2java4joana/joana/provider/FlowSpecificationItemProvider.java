...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.scbs.pcm2java4joana.joana.FlowSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowSpecificationItemProvider extends JoanaElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JoanaPackage.Literals.FLOW_SPECIFICATION__ENTRYPOINT);
			childrenFeatures.add(JoanaPackage.Literals.FLOW_SPECIFICATION__ANNOTATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(JoanaPackage.Literals.FLOW_SPECIFICATION__ENTRYPOINT,
				JoanaFactory.eINSTANCE.createEntryPoint()));

		newChildDescriptors.add(createChildParameter(JoanaPackage.Literals.FLOW_SPECIFICATION__ANNOTATION,
