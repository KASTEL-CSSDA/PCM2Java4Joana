...
/**
 * This is the item provider adapter for a {@link sourcecode.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider extends TopLevelTypeItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Class_implements_feature",
								"_UI_Class_type"),
						SourcecodePackage.Literals.CLASS__IMPLEMENTS, true, false, true, null, null, null));
	}
	...
	protected void addFieldsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_fields_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Class_fields_feature", "_UI_Class_type"),
						SourcecodePackage.Literals.CLASS__FIELDS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((sourcecode.Class) object).getName();
