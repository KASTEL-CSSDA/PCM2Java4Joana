...
public class FlowSpecificationImpl extends EntityImpl implements FlowSpecification {
	...
	public NotificationChain basicSetEntrypoint(EntryPoint newEntrypoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JoanaPackage.FLOW_SPECIFICATION__ENTRYPOINT, oldEntrypoint, newEntrypoint);
	...
	public void setEntrypoint(EntryPoint newEntrypoint) {
		if (newEntrypoint != entrypoint) {
			...
			if (entrypoint != null)
				msgs = ((InternalEObject)entrypoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JoanaPackage.FLOW_SPECIFICATION__ENTRYPOINT, null, msgs);
			if (newEntrypoint != null)
				msgs = ((InternalEObject)newEntrypoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JoanaPackage.FLOW_SPECIFICATION__ENTRYPOINT, null, msgs);
			msgs = basicSetEntrypoint(newEntrypoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JoanaPackage.FLOW_SPECIFICATION__ENTRYPOINT, newEntrypoint, newEntrypoint));
	}
