 ...
 * </p>
 * <ul>
 *   <li>{@link sourcecode.impl.ReferenceTypeImpl#getTopleveltype <em>Topleveltype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceTypeImpl extends TypeImpl implements ReferenceType {
			...
			if (topleveltype != oldTopleveltype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SourcecodePackage.REFERENCE_TYPE__TOPLEVELTYPE, oldTopleveltype, topleveltype));
			}
		}
		return topleveltype;
	}
	...
	public void setTopleveltype(TopLevelType newTopleveltype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SourcecodePackage.REFERENCE_TYPE__TOPLEVELTYPE,
					oldTopleveltype, topleveltype));
	}
