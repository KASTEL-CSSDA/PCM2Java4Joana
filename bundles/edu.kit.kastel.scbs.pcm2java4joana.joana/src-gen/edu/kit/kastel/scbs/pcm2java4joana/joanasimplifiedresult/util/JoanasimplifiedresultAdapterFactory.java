/**
 */
package edu.kit.kastel.scbs.pcm2java4joana.joanasimplifiedresult.util;
 ...
 * @generated
 */
public class JoanasimplifiedresultAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static JoanasimplifiedresultPackage modelPackage;
	 ...
	 * @generated
	 */
	public JoanasimplifiedresultAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = JoanasimplifiedresultPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected JoanasimplifiedresultSwitch<Adapter> modelSwitch =
		new JoanasimplifiedresultSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseTraceState(TraceState object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.pcm2java4joana.joanasimplifiedresult.Result <em>Result</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.pcm2java4joana.joanasimplifiedresult.Trace <em>Trace</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.pcm2java4joana.joanasimplifiedresult.TraceState <em>Trace State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //JoanasimplifiedresultAdapterFactory
